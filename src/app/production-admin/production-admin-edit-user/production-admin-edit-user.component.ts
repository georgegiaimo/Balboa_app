...
@Component({
  selector: 'app-production-admin-edit-user',
  standalone: false,
  templateUrl: './production-admin-edit-user.component.html',
  styleUrl: './production-admin-edit-user.component.css'
})
export class ProductionAdminEditUserComponent implements OnInit {
  ...
  loadProduction(){
    this.apisService.GetProductionDetails(this.userx.production_id).subscribe((data:any) => {
  ...
  gotoUserDetails(){
    ...
    else this.router.navigate(['p/users']);
  }
