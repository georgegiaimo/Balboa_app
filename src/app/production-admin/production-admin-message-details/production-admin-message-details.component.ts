...
@Component({
  selector: 'app-production-admin-message-details',
  standalone: false,
  templateUrl: './production-admin-message-details.component.html',
  styleUrl: './production-admin-message-details.component.css'
})
export class ProductionAdminMessageDetailsComponent implements OnInit{
