...
@Component({
  selector: 'app-executive-admin-messaging',
  standalone:false,
  templateUrl: './executive-admin-messaging.component.html',
  styleUrl: './executive-admin-messaging.component.css'
})
export class ExecutiveAdminMessagingComponent implements OnInit{
  ...
  gotoMessageDetails(message_id:number){
    this.router.navigate(['e/message-details/'+ message_id])
  }
